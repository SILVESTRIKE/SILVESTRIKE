...
> **ML-based price optimization system** using deep learning for predictive pricing analysis.

`Python` `Jupyter Notebook` `Deep Learning` `Data Analysis`
...
<img height="180em" src="https://github-readme-stats.vercel.app/api?username=SILVESTRIKE&show_icons=true&theme=github_dark&hide_border=true&bg_color=0d1117&title_color=58a6ff&icon_color=58a6ff&text_color=c9d1d9&count_private=true" />
<img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=SILVESTRIKE&layout=compact&theme=github_dark&hide_border=true&bg_color=0d1117&title_color=58a6ff&text_color=c9d1d9&langs_count=8" />
...
```
🔬 Building    → Veritas: Vietnamese Law AI Assistant (Graduation Thesis)
📚 Learning    → LLM Fine-tuning, RAG Architecture, MLOps
🏗️ Exploring   → Vector Databases, Agent Frameworks, Cloud Deployment
🎯 Goal        → Ship AI products that solve real problems for Vietnamese users
```
...
- 🤖 **AI/ML Engineer** — Internship or Junior positions
- 💻 **Software Engineer** — Full-stack or Backend roles
- 🌏 **Remote Work** — Open to international teams
- 🔧 **Freelance Projects** — AI integration, Web development
- 🤝 **Open Source** — Collaboration on AI/ML projects

> **If my work interests you, let's talk.** I respond to every message.
